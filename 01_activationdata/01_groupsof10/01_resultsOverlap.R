...
path1 <-p<- "./Onderzoek/doctoraat/scripts/Paper04/01_data/02_emotion/01_smallN/01_results/01_smResids/"
...
i=1
path2 <- paste(path1, sprintf("%04d", i), sep="")
tmp   <- read.table(paste(path2, "STAB.txt", sep="/"), header=TRUE)
