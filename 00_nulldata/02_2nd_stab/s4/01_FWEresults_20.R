...
p.tmp<-"./Onderzoek/Paper04/01_data/00_null_s4"
...
control.file <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","filecon", sep="")
control.file2 <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","smoothness",sprintf("n20%04d", i), sep="")
control.file3 <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","STAB_OUT001.txt", sep="")
control.file4 <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","STAB_OUT005.txt", sep="")
control.file5 <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","STAB_OUT01.txt", sep="")
control.file6 <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","STAB_OUT05.txt", sep="")
...
# file paths
sm.path <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","smoothness",sprintf("n20%04d", i), sep="")
fc.path001 <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","STAB_OUT001.txt", sep="")
fc.path005 <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","STAB_OUT005.txt", sep="")
fc.path01 <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","STAB_OUT01.txt", sep="")
fc.path05 <- paste(p.tmp, "/", sprintf("n20%04d", i),"/","STAB_OUT05.txt", sep="")
...
save(FWE001, FWE005, FWE01, FWE05, file="./Onderzoek/Paper04/01_data/03_null/s4_20_FWE.Rdata")
# what about OLS?
