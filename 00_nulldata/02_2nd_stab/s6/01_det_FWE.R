...
p.tmp<-"./Onderzoek/Paper04/01_data/00_null_OLS"
...
sizes001 <- read.table(fc.path001, header=TRUE)
...
dim(sizes005[which(sizes005$p<0.005),])[1]+ dim(sizes005[which(sizes005$p>0.005 & sizes005$p<0.01 & sizes005$Stability>0.6),])[1],
dim(sizes005[which(sizes005$p<0.005),])[1]+ dim(sizes005[which(sizes005$p>0.005 & sizes005$p<0.01 & sizes005$Stability>(2/3)),])[1],
dim(sizes005[which(sizes005$p<0.005),])[1]+ dim(sizes005[which(sizes005$p>0.005 & sizes005$p<0.01 & sizes005$Stability>0.7),])[1],
dim(sizes005[which(sizes005$p<0.005),])[1]+ dim(sizes005[which(sizes005$p>0.005 & sizes005$p<0.01 & sizes005$Stability>0.8),])[1],
dim(sizes005[which(sizes005$p<0.005),])[1]+ dim(sizes005[which(sizes005$p>0.005 & sizes005$p<0.01 & sizes005$Stability>0.9),])[1])
